my_resume={"name":"sharmila",
           ...
           "project":["Rfid scan entry","frame work of python","authentication"],"Experience":["Help desk analyst","developer","Integration engineer"],"hobbies":["lesening music","cooking","going to temple"],
